...
class DashboardController extends Controller
{
  ...
  public function adminDashboard()
  {
    ...
    $data = [
      ...
      'totalFinance' => \App\Models\User::where('role', 'finance')->count(),
      'totalCreative' => \App\Models\User::where('role', 'creative_director')->count(),
      'totalTimInternal' => \App\Models\User::where('role', 'tim_internal')->count(),
      'totalSosmed' => \App\Models\User::where('role', 'sosmed_spesialis')->count(),
